...
import static com.github.jam01.xtrasonnet.document.MediaTypes.PARAM_CHARSET;
import static com.github.jam01.xtrasonnet.document.MediaTypes.PARAM_QUALITY_FACTOR;
...
public class MediaType implements Comparable<MediaType>, Serializable {
    ...
    public MediaType withParameter(String k, String v) {
        Map<String, String> params = new LinkedHashMap<>(getParameters());
        params.put(k, v);
        return new MediaType(this, params);
    }

    public MediaType withParameters(Map<String, String> params) {
        Map<String, String> params1 = new LinkedHashMap<>(getParameters());
        params1.putAll(params);
        return new MediaType(this, params1);
    }
