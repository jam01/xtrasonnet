        ...
        assertEquals(transform("""
                {
                    years: 20, months: 3, days: 1,
                    hours: 12, minutes: 30, seconds: 45
                }"""), transform("tro.duration.toParts('P20Y3M1DT12H30M45S')"));
    }
//
//    @Test
//    public void nother1() {
...
//
//        System.out.println(
//                transform("tro.duration.between('2039-12-22T07:24:26.425Z', '2019-09-20T18:53:41.425Z')")
//        );
//    }
}
