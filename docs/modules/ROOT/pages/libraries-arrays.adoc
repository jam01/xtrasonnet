...
.Example
----
tro.arrays.all([1, 2, 3], function(item) item > 0)
----
.Result
----
true
...
.Example
----
tro.arrays.any([1, 2, 3], function(item) item > 1)
----
.Result
----
true
...
.Example
----
tro.arrays.countBy([1, 2, 3], function(item) item > 2)
----
.Result
----
1
...
.Example
----
tro.arrays.deepFlatten([[1, 2], '3', [4, {}, [5, 6]]])
----
.Result
----
[1, 2, '3', 4, {}, 5, 6]
...
.Example
----
tro.arrays.distinctBy([1, 2, 3, 4, 5, 6], function(item) item % 3)
----
.Result
----
[1, 2, 3]
...
.Example
----
tro.arrays.distinctBy([1, 2, 3, 4, 5, 6], function(item, idx) item % (3 * idx))
----
.Result
----
[1, 2, 3, 4, 5, 6]
...
.Example
----
tro.arrays.dropWhile([1, 2, 3, 4, 5], function(item) item * 3 < 10)
----
.Result
----
[4, 5]
...
.Example
----
tro.arrays.duplicates([1, 2, 3, 1, 2])
----
.Result
----
[1, 2]
...
.Example
----
tro.arrays.find([1, 2, 3, 4, 5], function(item) item * 3 > 10)
----
.Result
----
[4]
...
.Example
----
tro.arrays.find([1, 2, 3, 4, 5], function(item, idx) item * (3 + idx) > 10)
----
.Result
----
[3]
...
.Example
----
tro.arrays.indexWhere([1, 2, 3, 4, 5], function(item) item * 3 < 10)
----
.Result
----
0
...
.Example
----
tro.arrays.indicesWhere([1, 2, 3, 4, 5], function(item) item * 3 < 10)
----
.Result
----
[1, 2, 3]
...
.Example
----
tro.arrays.lastIndexWhere([1, 2, 3, 4, 5], function(item) item * 3 < 10)
----
.Result
----
3
...
.Example
----
tro.arrays.occurrencesBy([1, 2, 3, 4, 5], function(item) if (item) < 4 then 'under4' else 'over4')
----
.Result
----
{ 'under4': 3, 'over4': 2 }
...
.Example
----
tro.arrays.partition([1, 2, 3, 4, 5], function(item) item < 4)
----
.Result
----
...
.Example
----
tro.arrays.splitAt([1, 2, 3, 4, 5], 3)
----
.Result
----
{ l: [1, 2, 3], r: [4, 5] }
...
.Example
----
tro.arrays.splitEvery([1, 2, 3, 4, 5], 2)
----
.Result
----
[[1, 2], [3, 4], [5]]
...
.Example
----
tro.arrays.splitWhere([1, 2, 3, 4, 5], function(item) item % 2 == 0)
----
.Result
----
{ l: [1], r: [2, 3, 4, 5] }
...
.Example
----
tro.arrays.takeWhile([1, 2, 3, 4, 5], function(item) item * 2 < 9)
----
.Result
----
[1, 2, 3, 4]
...
.Example
----
tro.arrays.unzipAll([[1, 'x'], [2], [3, 'z']], 'NA')
----
.Result
----
[[1, 2, 3], ['x', 'NA', 'z']]
...
.Example
----
tro.arrays.zipAll([[1, 2, 3], ['x', 'y']], 'NA')
----
.Result
----
[[1, 'x'], [2, 'y'], [3, 'NA']]
