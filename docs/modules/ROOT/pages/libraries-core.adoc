...
.Example
----
tro.contains({ scala: '3.1.3' }, 'scala')
----
.Result
----
true
...
.Example
----
tro.contains('Lorem ipsum', 'Lorem')
----
.Result
----
true
...
.Example
----
tro.endsWith('Lorem ipsum', 'ipsum')
----
.Result
----
true
...
.Example
----
tro.entriesOf({ scala: '3.1.3', java: '19' })
----
.Result
----
[
...
.Example
----
tro.filter([1, 2, 3, 4], function(item) item < 3)
----
.Result
----
[1, 2]
...
.Example
----
tro.filter([1, 2, 3, 4], function(item, idx) idx > 2)
----
.Result
----
[4]
...
.Example
----
tro.filterNotIn([1, 2, 3, 4, 3, 4], [3, 4])
----
.Result
----
[1, 2]
...
.Example
----
tro.flatMap([1, 3, 5], function(item) [item, item * item])
----
.Result
----
[1, 1, 3, 9, 5, 25]
...
.Example
----
tro.flatMap([1, 3, 5], function(item, idx) [item, item * idx])
----
.Result
----
[1, 0, 3, 3, 5, 10]
...
.Example
----
tro.foldLeft([1, 2, 3], 0, function(item, acc) item + acc)
----
.Result
----
6
...
.Example
----
tro.foldRight(['Lorem', 'ipsum', 'dolor'], '', function(item, acc) acc + ' ' + item)
----
.Result
----
' dolor ipsum Lorem'
...
.Example
----
tro.indicesOf('lorem ipsum dolor', 'lo')
----
.Result
----
[0, 14]
...
.Example
----
tro.keysOf({ scala: '3.1.3', java: '19' })
----
.Result
----
['scala', 'java']
...
.Example
----
tro.map([1, 2, 3, 4], function(item) item * item)
----
.Result
----
[1, 4, 9, 16]
...
.Example
----
tro.map([1, 2, 3, 4], function(item, idx) item * idx)
----
.Result
----
[0, 2, 6, 12]
...
.Example
----
tro.read('<hello>world!</hello>', 'application/xml')
----
.Result
----
{
...
.Example
----
tro.read('<hello>world!</hello>', 'application/xml', { textvaluekey: '_txt' })
----
.Result
----
{
...
.Example
----
tro.readUrl('example.com/data', 'application/xml')
----
.Result
----
{
...
.Example
----
tro.readUrl('example.com', 'application/xml', { textvaluekey: '_txt' })
----
.Result
----
{
...
.Example
----
tro.rmKey({ scala: '3.1.3', java: '19' }, 'java')
----
.Result
----
{ scala: '3.1.3' }
...
.Example
----
tro.rmKeyIn({ scala: '3.1.3', java: '19' }, ['java', 'scala'])
----
.Result
----
{}
...
.Example
----
tro.replace('hello, world!', 'world', 'everyone')
----
.Result
----
'hello, everyone!'
...
.Example
----
tro.reverse({ key1: 'value1', key2: 'value2' })
----
.Result
----
...
.Example
----
tro.startsWith('hello, world!', 'hello')
----
.Result
----
true
...
.Example
----
tro.valuesOf({ scala: '3.1.3', java: '19' })
----
.Result
----
['3.1.3', '19']
...
.Example
----
tro.write({ hello: 'world', arr: [], nil: null }, 'application/json')
----
.Result
----
...
.Example
----
tro.write({ hello: 'world', arr: [] }, 'application/json', { indent: true })
----
.Result
----
'{\n    "hello": "world",\n    "arr": [\n        \n    ]\n}'
