...
> Note: Trobador leverages the https://github.com/json-path/JsonPath[Jayway JsonPath library] which fully supports the https://goessner.net/articles/JsonPath/[JsonPath specification].
