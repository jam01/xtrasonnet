...
public class RootTest {
    ...
    public void entries() {
        Assertions.assertEquals(TestUtils.transform("""
                ...
                ]"""), TestUtils.transform("xtr.entries({ scala: '3.1.3', java: '19' })"));
    }
    ...
    @Test
    public void keys() {
        Assertions.assertEquals(TestUtils.transform("['scala', 'java']"), TestUtils.transform("xtr.keys({ scala: '3.1.3', java: '19' })"));
    }

    @Test
    public void toLowerCase() {
        Assertions.assertEquals(TestUtils.transform("'hello world!'"), TestUtils.transform("xtr.toLowerCase('Hello World!')"));
    }
    ...
    public void maxBy() {
        ...
        Assertions.assertEquals(TestUtils.transform("{ name: 'scala', version: '3.1.3', score: 'S' }"), TestUtils.transform("""
                local languages = [
    ...
    public void minBy() {
        ...
        Assertions.assertEquals(TestUtils.transform("{ name: 'java', version: '19', score: 'B' }"), TestUtils.transform("""
                local languages = [
                    { name: 'java', version: '19', score: 'B' },
                    { name: 'python', version: '3.1.14', score: 'B' },
                    { name: 'scala', version: '3.1.3', score: 'S' }
    ...
    public void read() {
        ...
        Assertions.assertEquals(TestUtils.transform("""
                {
                  hello: { _txt: 'world!' }
                }"""), TestUtils.transform("xtr.read('<hello>world!</hello>', 'application/xml', { textkey: '_txt' })"));
    }
    ...
    public void readUrl() {
        Assertions.assertEquals(TestUtils.transform("""
                {
                  hello: { '_text': 'world!' }
                }"""), TestUtils.transform("xtr.readUrl('classpath:readurl-data.xml', 'application/xml')"));
        Assertions.assertEquals(TestUtils.transform("""
                {
                  hello: { _txt: 'world!' }
                }"""), TestUtils.transform("xtr.readUrl('classpath:readurl-data.xml', 'application/xml', { textkey: '_txt' })"));
    }
    ...
    @Test
    public void length() {
        Assertions.assertEquals(TestUtils.transform("3"), TestUtils.transform("xtr.length([1, 2, 3])"));
        Assertions.assertEquals(TestUtils.transform("2"), TestUtils.transform("""
                local add(item, item2) = item + item2;

                xtr.length(add)"""));
        Assertions.assertEquals(TestUtils.transform("1"), TestUtils.transform("xtr.length({ key: 'value' })"));
        Assertions.assertEquals(TestUtils.transform("13"), TestUtils.transform("xtr.length('hello, world!')"));
    }
    ...
    @Test
    public void values() {
        Assertions.assertEquals(TestUtils.transform("['3.1.3', '19']"), TestUtils.transform("xtr.values({ scala: '3.1.3', java: '19' })"));
    }
